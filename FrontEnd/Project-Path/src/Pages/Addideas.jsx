...
>>>>>>> e04ab89d07a275d9d5e5488f975dcf4952f09561
  };
  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex-1 container mx-auto p-6">
        ...
        <div className="flex-1 p-6 bg-base-100 rounded-lg shadow-lg mx-8 mt-16 h-3/4">
          <p className="text-[#FF6565] text-sm text-start mb-2">
            {errorMessage}
          </p>
          ...
          <div className="form-control h-3/4 w-full relative">
            <label className="label">
