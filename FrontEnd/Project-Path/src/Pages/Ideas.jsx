        ...
        <div className="flex-1 container mx-auto p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 my-6">
            {currentCards.map((card) => (
              <Card
                key={card._id} // Use the unique ID from the fetched data
                title={card.title}
                date={card.ideaStatus} // You can adjust this field as necessary
                description={card.ideaDescription} // Use the idea description
              />
            ))}
          </div>
