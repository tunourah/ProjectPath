...
function Nav() {
  ...
  return <>
   <img className="md:invisible xs:visible absolute left-4 top-4 " src="https://i.ibb.co/172TmgX/menu.png" onClick={show} />
  <nav id="nav" className="bg-[white] md:w-1/5 md:shadow-2xl xs:shadow-0 xs:w-5/5 xs:absolute z-1 flex flex-col justify-between" style={{height:"100vh",maxHeight:"100%"}} >
  <img className="md:invisible xs:visible absolute left-[85%] top-4 z-1" src="https://i.ibb.co/d0dgRNS/close.png" onClick={hide}/>
 
<ul className="text-[#6d6d6d] " >
<li  className="text-2xl font-bold flex items-center justify-center text-[black]" >project<span className="text-[#26dec6]">path </span><img className="w-1/5 max-w-12 pl-1" src="https://i.ibb.co/4Z3LnpB/logo-g.png" alt="" srcset="" /></li>
